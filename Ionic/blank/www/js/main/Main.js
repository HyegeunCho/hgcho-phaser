window.START_ANIPANG = function()
{
	...
	this.game = new Phaser.Game(480, 800, Phaser.AUTO, 'gameArea');
	//this.game = new Phaser.Game(window.innerWidth * window.devicePixelRatio, (window.innerHeight * window.devicePixelRatio) - 45 * window.devicePixelRatio, Phaser.AUTO, 'gameArea');
