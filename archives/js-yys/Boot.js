...
Boot.prototype.preload = function() {
	...
	var imageUrl = ["assets-yys/preImage/preBackGound.png"];
	
	this.load.pack("preload", "assets-yys/assets-pack.json");
	this.game.load.images(imageArray, imageUrl);
	this.game.load.atlas("PREIMAGE", "assets-yys/preImage/preImage.png", "assets-yys/preImage/preImage.json", Phaser.Loader.TEXTURE_ATLAS_JSON_ARRAY);
};
